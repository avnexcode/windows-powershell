...
. $HOME/.windows-setup/commands/next-app/Options.ps1
. $HOME/.windows-setup/commands/vite-app/Options.ps1
. $HOME/.windows-setup/commands/php-app/Options.ps1
. $HOME/.windows-setup/commands/js-app/Options.ps1